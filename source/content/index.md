...
- **HPC (High-performance computing)**: use of powerful parallel computing systems to solve compute-intensive workloads such as simulations, scientific computing, and large-scale machine-learning jobs. #compute #parallel-computing
