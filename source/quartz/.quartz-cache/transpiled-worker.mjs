  ...
  const Search = /* @__PURE__ */ __name(({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ jsxs14("div", { class: classNames(displayClass, "search"), children: [
      /* @__PURE__ */ jsxs14("button", { class: "search-button", id: "search-button", children: [
        ...
        /* @__PURE__ */ jsxs14("svg", { role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 19.9 19.7", children: [
          /* @__PURE__ */ jsx25("title", { children: "Search" }),
...
var config = {
  configuration: {
    pageTitle: "Davide's notes \u{1F427}",
    pageTitleSuffix: "",
    enableSPA: true,
    enablePopovers: true,
    analytics: {
